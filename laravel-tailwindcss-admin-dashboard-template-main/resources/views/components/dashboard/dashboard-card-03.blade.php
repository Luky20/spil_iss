<div class="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white shadow-xs rounded-xl">
    <div class="px-5 pt-5">
        <header class="flex justify-between items-start mb-2">
            <h2 class="text-lg font-semibold text-gray-800">OPS</h2>
            <!-- Menu button -->
        ...
        <div class="flex items-center justify-center">
            <canvas id="chart-acme-plus-3" class="w-24 h-24"></canvas>
        </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        let ctx = document.getElementById("chart-acme-plus-3").getContext("2d");
        new Chart(ctx, {
            type: 'doughnut',
            data: {
                datasets: [{
